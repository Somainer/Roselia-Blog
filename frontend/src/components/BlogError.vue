  ...
  <div>
    <div class="top-details">
      ...
      <header class="exception-info">
        ...
        <h5 class="struct blog-text">
          RoseliaBlog.Router.{{errorCode}}Error
          <small>at {{method}}</small>
          <small class="path">{{path}}</small>
        </h5>
        <h1 class="title blog-text">an error found for {{method}} {{path}} (RoseliaBlog.Router)</h1>
      ...
      <div class="code-explorer">
        <div class="code-snippets">
          ...
          <div class="frame-info -active" data-index="0" role="stack-trace-details">
            <div class="file">
              <a href="">lib/roselia_blog/router</a>
            </div>

            <pre class="black--text code code-block"><span class="line"><span class="ln">1</span><span class="code">class RoseliaBlog.Router extends Router{</span></span>
                        <span class="line "><span class="ln">2</span><span class="code">  ...</span></span>
                        <span class="line "><span class="ln">3</span><span class="code"></span></span>
                        <span class="line "><span class="ln">233</span><span class="code">  def route(path: String): Request =&gt; Response = path match {</span></span>
                        <span class="line "><span class="ln">234</span><span class="code">    case &quot;/&quot; =&gt; Controller.index</span></span>
                        <span class="line "><span class="ln">235</span><span class="code">    ...</span></span>
                        <span class="line -highlight"><span class="ln">666</span><span class="code">    case "{{ path }}" =&gt; {{errorTaunt}}</span></span>
                        <span class="line "><span class="ln">667</span><span class="code">  }</span></span>
                        <span class="line "><span class="ln">668</span><span class="code">  def scope(scop: String)(f: Request =&gt; Response): Request =&gt; Response = {</span></span>
                    </pre>
            ...
            <div class="meta">
              <div class="frame-mfa">
                ...
                <a class="docs right blog-text" href="/">index</a>

                <span class="app right">RoseliaBlog</span>
        ...
        <div class="stack-trace">
          ...
          <ul class="stack-trace-list -show-all" role="stack-trace-list">
            ...
            <li>
              <button class="stack-trace-item -app -active" role="stack-trace-item" data-index="0">
                            <span class="left">

                                <span class="app">RoseliaBlog</span>

                                <span class="filename">
                                    lib/roselia_blog/router<span class="line">:666</span>
                                </span>
                            </span>

                <span class="info">RoseliaBlog.Router.route: (path: String): Request =&gt; Response</span>
              </button>
            </li>
            <li>
              <router-link to="/" class="stack-trace-item" role="stack-trace-item" data-index="0">
                            <span class="left">
                ...
                <span class="info">_ => RoseliaBlog.Router.route("index")</span>
              </router-link>
            </li>
          </ul>
        </div>
    ...
    <div class="conn-info">
      ...
      <details class="conn-details">
        <summary>Known info</summary>
        <dl>
          <dt>Instance:</dt>
          <dd class="code-quote">{{title}}</dd>
        </dl>

        <dl>
          <dt>URI:</dt>
          <dd class="code-quote">{{path}}</dd>
        </dl>

        <dl>
          <dt>Description:</dt>
          <dd class="code-quote">{{motto}}</dd>
        </dl>
        <dl>
          <dt>Error:</dt>
          <dd class="code-quote">{{errorCode}} - {{errorTaunt}}</dd>
        </dl>
      </details>
...
export default {
  ...
  data () {
    return {
      ...
      errorTaunt: 'Maybe Marisa has stolen something important',
      title: meta.title,
      motto: meta.motto,
      link: this.$router.resolve({name: 'index'}),
...
<style scoped>
  ...
  * {
  ...
  @-webkit-keyframes line-highlight {
    ...
    25% { background-color: #c3b4fd; }
    50% { background-color: #f0f4fa; }
    75% { background-color: #c3b4fd; }
  }
